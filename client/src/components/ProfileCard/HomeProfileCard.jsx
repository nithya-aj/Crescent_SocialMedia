...
const HomeProfileCard = () => {
    ...
    return (
        <Card sx={{ maxWidth: 345, width: '16rem', borderRadius: '16px', backgroundColor: 'black', color: '#989080' }}>
            <CardMedia
                component="img"
                alt="green iguana"
                height="110"
            ...
            <CardContent>
                ...
                <Divider sx={{ backgroundColor: '#989080' }} variant="middle" />
                <Box component='div' sx={{ justifyContent: 'center', alignItems: 'center', display: 'flex' }}>
                    <Button variant="outlined" sx={{ marginTop: '1.5rem', background: 'linear-gradient(98.63deg, #5725f9 0%, #f95f35 100%)', color: 'white', border: 'none' }} >
